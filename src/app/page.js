...
export default function Home() {
  ...
  return (
    <div className="container">
      <h1 className="header">AI Newsletter Machine</h1>
      <div className="grid">
        <div className="column">
          <div className="options">
            <input
              ...
              placeholder="Enter the link you want to create a blog post"
            />
          ...
          {blogPost ? (
              ...
              <p className="blog-post-info"><span>ℹ️</span><span>No blog post available yet</span><span>Enter a topic and click <b>Generate</b> to see results here.</span></p>
            )}
          </div>
        </div>
